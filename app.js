...
app.get("/whatsapp", (req, res) => {
    ...
    if (!clientReady) {
        return res.status(500).json({ success: false, message: "WhatsApp Client is not ready." });
    }

    // Redirect to the WhatsApp Web page hosted by Puppeteer
    res.redirect("http://localhost:9222"); // Replace with Puppeteer's debugging URL if needed
});
